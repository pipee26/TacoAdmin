...
<body>
    ...
    <h4 id="h4perfil">Actualizar datos de usuario</h4>
    <br><br>
    ...
    <table class="table table-success col-md-8" id="tablaperfil">
        ...
        <tbody>
            ...
            <?PHP
                ...
                $consul="SELECT * FROM admin WHERE id='1'";
    ...
    <br>
    <div id="btnperfiltrabajador">
        <a href="perfiltrabajador.php" >
            <button type="submit" class="btn btn-success" name="btn"> Actualizar Trabajador</button>
        </a>
    </div>
